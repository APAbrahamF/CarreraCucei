...
class DbOperation
{
	...
	public function insertHistorial($nombre, $imagen, $estado, $municipio, $sexo, $edad, $IDServicio_FK, $IDUsuario_FK){
		...
		$stmt->bind_param("ssssssss", $nombre, $imagen, $estado, $municipio, $sexo, $edad, $IDServicio_FK, $IDUsuario_FK);
		if($stmt->execute())
			return true; 
		return false; 
	}
